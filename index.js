...
var listLinks = headerLinks.getElementsByClassName('for-hover');
...
for (let i = 0; i < addToCartButtons.length; i++) {
  ...
  button.addEventListener(`click`, function addToCartClicked(event) {
    ...
    let title = document.getElementsByClassName(`hanging-laundry-heading`)[0]
      .textContent;
...
function addItemToCart(title, price, imageSrc) {
  ...
  cartRow
    .getElementsByClassName(`item-remove-btn`)[0]
...
for (let i = 0; i < addToCartButtons.length; i++) {
  ...
  button.addEventListener(`click`, function addToCartClicked(event) {
    ...
    let shopItem = button.parentElement;
    let title =
      document.getElementsByClassName(`keyHolder-heading`)[0].textContent;
    let price = shopItem.getElementsByClassName(`price-tag`)[0].innerText;
...
for (let i = 0; i < addToCartButtons.length; i++) {
  ...
  button.addEventListener(`click`, function addToCartClicked(event) {
    ...
    let shopItem = button.parentElement;
    let title =
      document.getElementsByClassName(`showerbag-heading`)[0].textContent;
    let price = shopItem.getElementsByClassName(`price-tag`)[0].innerText;
